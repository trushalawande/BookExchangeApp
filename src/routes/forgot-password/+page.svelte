...
<div class="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-3xl mx-auto">
    <div class="bg-white shadow-xl rounded-lg overflow-hidden glass-effect">
      <h1 class="text-3xl font-bold text-gray-900 text-center mb-8 pt-8">Reset Password</h1>
      <div class="px-4 py-5 sm:p-6">
        ...
        <form on:submit|preventDefault={handleResetPassword} class="mb-8">
          ...
          <button type="submit" class="w-full bg-black text-white py-2 px-4 rounded-md hover:bg-black">
            Send Reset Link
          </button>
        </form>
